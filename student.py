...
class Student:
    def __init__(self,root):
        ...
        btn_Frame.place(x=15,y=500,width=560)
        ...
        txt_search=Entry(Detail_Frame,width=15,font=("times new roman",10,"bold"),bd=5,relief=GROOVE)
        txt_search.grid(row=0,column=2,pady=10,padx=20,sticky="w")
        
        searchbtn=Button(Detail_Frame,text="SEARCH",width=10,pady=5).grid(row=0,column=3,padx=10,pady=10)
        showallbtn=Button(Detail_Frame,text="SHOWALL",width=10,pady=5).grid(row=0,column=4,padx=10,pady=10)
        #==table===
